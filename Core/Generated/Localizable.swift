...
internal enum L10n {
  ...
  internal enum ExercisePicker {
    ...
    internal enum PickedSection {
      ...
      internal static let emptyPlaceholder = L10n.tr("Localizable", "exercisePicker.pickedSection.emptyPlaceholder")
      /// Picked exercises
      internal static let title = L10n.tr("Localizable", "exercisePicker.pickedSection.title")
    }
  }
  ...
  internal enum Planner {
    ...
    internal enum BottomBar {
      internal enum WorkoutName {
        /// Workout name
        internal static let placeholder = L10n.tr("Localizable", "planner.bottomBar.workoutName.placeholder")
      }
    }
